...
const log = {
  ...
  success: (msg: string, data?: any) => {
    console.log(`\x1b[32m[MOCK-GEN ✓]\x1b[0m ${msg}`, data !== undefined ? data : '');
  },
  warn: (msg: string, data?: any) => {
    console.log(`\x1b[33m[MOCK-GEN ⚠]\x1b[0m ${msg}`, data !== undefined ? data : '');
  },
  error: (msg: string, data?: any) => {
    console.log(`\x1b[31m[MOCK-GEN ✗]\x1b[0m ${msg}`, data !== undefined ? data : '');
  },
  debug: (msg: string, data?: any) => {
    console.log(`\x1b[90m[MOCK-GEN 🔍]\x1b[0m ${msg}`, data !== undefined ? data : '');
  }
};
